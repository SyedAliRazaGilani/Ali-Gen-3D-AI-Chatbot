export default function ProjectDetailCard({ title, summary, githubUrl, imageUrl }) {
  return (
    <div className="rounded-3xl border border-white/20 bg-black/35 backdrop-blur-xl overflow-hidden text-white">
      <div className="relative h-40 sm:h-44 bg-gradient-to-br from-slate-700/90 via-violet-900/60 to-black">
        ...
        <div className="absolute bottom-3 left-4 right-4">
          ...
          <div className="text-white/80 text-xs sm:text-sm mt-1 drop-shadow-sm">Portfolio project</div>
        </div>
      </div>
      ...
      <div className="p-4">
        ...
        {githubUrl ? (
          <div className="mt-5 flex flex-wrap items-center justify-between gap-3">
            <span className="text-white/60 text-sm">Source code</span>
            <a
              href={githubUrl}
              target="_blank"
              rel="noreferrer"
